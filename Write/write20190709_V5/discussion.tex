...
microblog contents and stress changing patterns on over whelmed adolescents,
and verified that the stress-buffering effects of positive events are reflected in
both slowing down stress increase at early stage,
and prompting the stress reduction at the later stage.
...
2) quantification of relationships between stress-buffering of positive events and microblogging measures,
and 3) real-time model monitoring the stress-buffering process in adolescents.
...
On the one hand, it realized timely and continuous monitoring of the stress-buffering process of adolescents based on public social network data sources, which can be used to assess the stress resistance of adolescents;
...
%The present study gives a deep inside into the stress-buffering function of positive events.
%%做了啥：首次提出
%We first proposed a comprehensive framework to depict and assess stress-buffering characters in behavioural level,
%analyze the dynamic process of stress-buffering function of positive events,
%and extend traditional survey-based methods to automatically detection methods based on social network data.
