...
\title{Assessment of Stress-Buffering Effects of Uplift Events on Adolescents from Microblogs}
...
Previous research has explored the possibility of sensing teenagers' stress from social network.
while the research on auto-analyzing the restoring ability of uplift events still calls for more exploration. 
In this paper,
we give a deep inside into the stress-buffering function of uplift events on the real data set of 124 high school students. 
...
%2.1心理压力缓解的概念
Traditional psychology research shows that stress-restoring could function through various ways,
including exercise[xx], self-esteem [xx], changing environments [xx], chatting with friends [xx],
writing diaries [xx] and so on.
The specific restoring restoring mode remains to be further explored.
%2.2 人们探求缓解心理压力的多种途径，但是具体的缓解模式仍有待探索。

With the epidemic of social media among adolescents,
...
However, research on stress-buffering effects of uplift events from social networks still calls for more exploration.
%5.但是对于积极事件的研究还远远不够
This article will explore the restoring impact of uplift events from microblogs,
help scheduling positive interventions, and predict future stress.
