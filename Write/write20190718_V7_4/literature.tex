...
Interpretation of Positive Events Scale (\emph{IPES})~\citep{Alden2008Social}, 
Perceived Benefit Scales~\citep{Mcmillen1998The}, 
Adolescent Self-Rating Life Events Checklist~\citep{Jun2008Influence}.
For example, 
\citep{Mcmillen1998The} proposed the \emph{Perceived Benefit Scales} as a new measure of self-reported positive life changes after traumatic stressors (i.e., lifestyle changes, family closeness, community closeness). 
\citep{Jun2008Influence} investigated 282 college students using the \emph{Adolescent Self-Rating Life Events Checklist}, 
and found that the training of positive coping style is of great benefit to improve the mental health of students. 
However, the above explorations based on self-report investigations 
...
%!!!!! current: positive和stress达成了一致的认同：但是都是self-report; 
%!!!!!! 本文想通过大数据来..., 并做出方法上的创新，理论上的扩展，实践上的探索。
