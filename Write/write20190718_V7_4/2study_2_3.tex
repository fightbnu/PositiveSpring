...
\label{partstudy2}
In this section, 
we first extracted positive events from microblogs. 
Multiple microblog content and behavioral measures are examined to depict the stress-buffering pattern of positive events based on hypothesis H1. 
The effect of positive events is modeled as adolescents' behavioral differences in two cases: 
