...
Therefore, if the stress-buffering effect of positive events could be automatically assessed on each individual,
...
\paragraph{Sensing adolescent stress from social networks}
...
H3: Positive events could predict teen's future stress.
...
Firstly, we conducted a case study on real microblogs of 124 high school students associated with the school's scheduled uplift and stressor event list,
