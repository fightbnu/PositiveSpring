...
%findings
Positive events were found to alleviate the psychological stress of overwhelmed high school students on microblogs, 
...
%结果表明 1)预测有用 2)最有效的种类 3)correlation最强 4）
The results show that 
incorporating the stress-buffering effects of positive events in the process of stress prediction could improve the accuracy of results.

%We first detect positive events and impact interval, 
%quantify the stress-buffering impact of different types of positive events, 
%and predict the stress mitigation from microblogs. 
