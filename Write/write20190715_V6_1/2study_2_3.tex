...
\includegraphics[width=\linewidth]{figs/correlation2.eps}%figs/correlation2.eps
...
%The overall pipeline for identifying the restoring impact of  events is presented in algorithm \ref{alg:alg4}.
