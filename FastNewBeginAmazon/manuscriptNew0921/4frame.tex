...
Finally, a none-liner time series model was proposed
to combine stress-buffering patterns into future stress prediction.
...
\subsubsection{Modeling the Stress-buffering Impact of Positive Events}
In our problem,
...
\subsubsection{Identifying the monotonous stress changes of stress-buffering}
\label{mod:mod2}
...
\subsection{Stress Prediction Model Integrating Stress-buffering Effects}
