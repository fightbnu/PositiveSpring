...
and aims at a solution at both microblogging content and behavioral levels
under the hypothesis that
1)the occurrence of positive events can be reflected in adolescents' microblogs,
and 2)positive events causes monotonous changes in stress.
the moment in which a positive event occur is related to stress-buffering effects.
...
despite the unique advantages of social networks over traditional survey methods
...
We extend the study to integrating stress-buffering patterns into future stress prediction in section \ref{subsec:predict},
and present the experimental results in section \ref{subsec:experiment}.
The future work is discussed in section \ref{sec:conclude}.
