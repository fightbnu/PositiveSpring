...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{figs/gray/topic.eps}
...
The forth measure \emph{forwarded frequency} was the number of re-tweet and shared microblogs. 
