...
and caused more fluctuations (subgraph (c)) during stressful intervals.
On the other hand,
...
Another important measure was wether self-mentioned words (i.e., 'I','we','my') existed,
since self-mentioned words exhibited high probability that the current event was related to the author,
rather than the opinion about a public event or life events about others (\citep{Li2014Major}).
Figure \ref{fig:topicAll} (a) and (b) showed the frequency of
stressful emotional words and positive emotional words, respectively.
...
romantic and self-cognition stressor events (subgraph \ref{fig:topicAll} (a)).
While the frequency of positive emotions exhibited no increase
during stressful intervals in family life and peer relationship dimensions (subgraph \ref{fig:topicAll} (b)).
...
These revealed our hypothesis
that the occurrence of positive events didn't reduce the post of positive events,
while they offset the impact of stressor events through talking about positive topics at the same time.
%To be modify1: the title and () in figure 6.
%To be modify 3: role好像丢了
\begin{figure}[h]
\centering
...
increase of positive microblogs when positive events occurred. %???To be modify? 查看原图确定。
Subgraph (d) indicated the increase of forwarded microblogs when positive events happened,
while subgraph (c) showed that the frequency of all microblogs didn't appear obvious change
