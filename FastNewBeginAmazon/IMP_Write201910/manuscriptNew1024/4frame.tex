...
We considered 4 measures of posting behaviors here. 
The first measure was \emph{posting frequency}, 
representing the total number of posts per day. 
The second measure was the \emph{positive posting frequency}, indicating the number of positive microblogs per day. 
The third measure \emph{stressful posting frequency} highlighted the stressful microblogs among all posts.  
...
The forth measure \emph{original frequency} was the number of original microblogs, 
which filtered out re-tweet and shared microblogs. 
Original posts indicated higher probability that users were talking about themselves. 
Figure \ref{fig:post}showed the distribution of above 4 measures in U-SI and SI, respectively. 
%to be modify2 (difference)
