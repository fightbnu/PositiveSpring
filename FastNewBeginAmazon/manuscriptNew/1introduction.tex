...
%静态的; 行为和内容是自发的，避免干扰; 
The aforementioned could be viewed as static sensing of stress-buffering.....
...
Another difference from the previous work lies in that ..

\emph{Our work}: 
To this end, the current study aims to examine the potential relationship between positive events and its stress-buffering pattern from adolescents' microblog content and behavioral characteristics. 
...
%1
In the study, we follow the categorization of adolescents' positive events from six dimensions (....),
and stressor events from five dimensions (.....) widely adopted. 
%structure of a positive event
We extract uplift events and the corresponding impacted interval from microblogs. 
...
%4
The stress-buffering pattern are integrated into stress prediction. 
